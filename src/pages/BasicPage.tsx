...
builder.quote(<SubatomicGraphic />)`
...
`.paragraph()`
양자역학이 대체 무엇일까요? 아주 간단하게 말해서, 양자역학은 "작은 것들을 연구하는 학문" 입니다. 원자, 전자, 광자같이 육안으로는 절대 관찰할 수 없을 만큼 작은 이 입자들의 성질을 밝혀내는 것이 양자역학의 목표라고 할 수 있습니다.
