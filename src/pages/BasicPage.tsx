...
이게 무슨 말같지도 않은 소리일까요? 고양이가 죽은 동시에 살아있다뇨? 하지만 이것이 현재 양자역학계에서 정설로 받아들여지고 있는 해석(코펜하겐 해석)입니다.

입자는 관측하기 전까지 여러 상태가 동시에 중첩되어 존재하며, 관측하는 순간 하나의 상태로 결정된다.  양자역학에서는 이렇게 여러 상태가 동시에 존재하는 현상을 중첩(superposition)이라고 합니다. 
`;
