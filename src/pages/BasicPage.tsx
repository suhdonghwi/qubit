...
아까 공 던지기 실험에서 보았던 이중 슬릿입니다. 이 이중 슬릿에 파동을 통과시키면 파동은 어떻게 진행하고, 벽에는 어떤 모양의 그래프가 그려질까요? 쉽지는 않겠지만, 한 번 생각해보세요!
---
...
---
슬릿 앞에 관측 장치를 설치하고 실험을 진행하자, 이번에는 띠 모양의 무늬가 나타났습니다. 관측을 시작하니, 파동같은 성질을 보이던 전자가, 마치 자신이 관측당하고 있다는 사실을 알고있는 것 마냥 다시 입자처럼 행동하기 시작했다는 것입니다.

과학자들은 그야말로 대혼란에 빠지게 됩니다. 이런 말도 안되는 상황이 가능한 것일까? 실험에 오류가 있는 것은 아닐까? 하지만 거듭된 실험에서도 같은 결과가 나타날 뿐이었습니다.

이런 말도 안되는 결과를 해석하기 위한 이론을 과학자들이 하나둘씩 내놓기 시작하면서, 양자역학의 시대가 열리게 되었습니다.
`;
