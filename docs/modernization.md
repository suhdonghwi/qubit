...
- Pretendard is bundled locally for page text and 3D labels, with its license included. Page text uses variable Unicode subsets to avoid downloading unused glyphs. Lesson quotations use locally bundled Nanum Myeongjo for a serif treatment; paragraphs share a global 1.75 line height.
